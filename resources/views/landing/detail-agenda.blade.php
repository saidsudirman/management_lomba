                        ...
                        <div class="post-body">
                            <div class="entry-header">
                                <div class="post-meta">
                                    ...
                                    ?>
                                    <span class="post-meta-date"><i class="far fa-calendar"></i>{{ $tgl_publish }}
                                        {{ $tgl_selesai }}</span>
                                    <span class="post-comment"><i class="far fa-clock"></i> <a href="#"
                                            class="comments-link"> {{ $jam_mulai }} - {{ $jam_selesai }} WITA</a>
                                    </span>
                                </div>
                                ...
                                @foreach ($latest_post as $v)
                                    <li class="d-flex align-items-center">
                                        <div class="posts-thumb">
                                            <a href="{{ route('user.detail.post', ['jenis' => $jenis, 'id' => $v->id]) }}"><img
                                        ...
                                        <div class="post-info">
                                            <h4 class="entry-title">
                                                <a
                                                    href="{{ route('user.detail.post', ['jenis' => $jenis, 'id' => $v->id]) }}">{{ $v->nama_kegiatan }}</a>
                                            </h4>
                                        </div>
                                    </li><!-- 1st post end-->
                                @endforeach
