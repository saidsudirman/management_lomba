                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input id="asal_sekolah" type="text" class="form-control"
                                                name="asal_sekolah" autofocus value="{{ $pen->asal_sekolah }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="status_pembayaran">Status Pembayaran</label>
                                            <div class="form-group">
                                                ...
                                                <select id="status_pembayaran" class="form-control" name="status_pembayaran" required>
                                                    <option value="1" {{ old('status_pembayaran', $pen->status_pembayaran) == '1' ? 'selected' : '' }}>
                                                        Belum Bayar
                                                    </option>
                                                    <option value="2" {{ old('status_pembayaran', $pen->status_pembayaran) == '2' ? 'selected' : '' }}>
                                                        Sudah Bayar
                                                    </option>
                                                </select>
                                            </div>
